...
exports.MarkovNamer = exports.MarkovChain = exports.Node = void 0;
...
function generate() {
    ...
    list.innerHTML = '';
    for (var i = 0; i < 4; i++) {
        var name_1 = namer5.get();
        var item = document.createElement('div');
        item.textContent = item.innerText = name_1;
        list.appendChild(item);
    }
    for (var i = 0; i < 1; i++) {
        var name_2 = namer3.get();
        var item = document.createElement('div');
        item.textContent = item.innerText = name_2;
        list.appendChild(item);
    }
    for (var i = 0; i < 3; i++) {
        var name_3 = namer4.get();
        var item = document.createElement('div');
        item.textContent = item.innerText = name_3;
        list.appendChild(item);
    }
    return list;
}
