...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__title_txt__ = __webpack_require__(4);
...
function start() {
    scene(__WEBPACK_IMPORTED_MODULE_4__scene_4_lunas_room_txt___default.a)
     //scene(scene1)
     //    .then(() => scene(scene2))
     //    .then(() => scene(scene3))
    //     .then(() => scene(scene4))
